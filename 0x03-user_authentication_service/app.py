...
def update_password() -> Response:
    """Update password
    """
    email: Optional[str] = response.form.get('email')
    new_password: Optional[str] = response.form.get('new_password')
    reset_token: Optional[str] = response.form.get('reset_token')
    try:
